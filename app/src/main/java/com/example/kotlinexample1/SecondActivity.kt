...
class SecondActivity : AppCompatActivity(){
    ...
    private final val baseUrl = "https://www.behindthename.come/name/"
    ...
    // when the button is clicked, send an implicit intent with the name passed through intent
    ...
    // start an activity with action view
        ...
        // template string
        // "${}" to put variables inside strings
